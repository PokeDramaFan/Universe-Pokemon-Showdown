...
var commands = exports.commands = {
	...
	whois: function (target, room, user, connection, cmd) {
		...
		} else if (targetUser.hasSysopAccess()) {this.sendReply("(System Operator)");}  else if (Config.superAdmins && Config.superAdmins[targetUser.userid]) this.sendReply("(Super Administrator)");
